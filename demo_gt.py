...
IMAGE_DIR ='./images/'
seg_dir ='/media/ltp/40BC89ECBC89DD32/LIPHP_data/LIP/SinglePerson/parsing/val_segmentations/'
file_names = '2001_430259'#next(os.walk(IMAGE_DIR))[2]
random.seed(120)
image = skimage.io.imread(IMAGE_DIR+file_names+'.jpg')
seg=skimage.io.imread(seg_dir+file_names+'.png')
# Run detection
